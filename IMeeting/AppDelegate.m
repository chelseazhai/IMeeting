...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.appRootViewController = [[AppRootViewController alloc] initWithPresentViewController:[[MeetingListViewController alloc] init] andMode:navigationController];
